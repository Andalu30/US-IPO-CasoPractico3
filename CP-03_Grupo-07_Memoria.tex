...
Para seleccionar la version de la web que queremos visitar existe una pantalla de selección en la que podemos seleccionar la web del país que queremos visitar. Así mismo, algunos paises nos permiten seleccionar el idioma que mostraran en la web.github
